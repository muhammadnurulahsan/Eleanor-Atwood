...
const Home = () => {
  ...
  return (
    <div>
      <div className="bg-home d-md-flex align-items-center mb-5">
      ...
      {/* skill sections card start here */}
      <div className="container mt-5 py-5 ">
        <div className="row row-cols-sm-1 row-cols-md-3">
          <div className="card text-center border-0">
            <div>
              <img src={img1} className="img-size" alt="" />
            </div>
            <div className="card-body">
              <h1 className="title-text">Study Support</h1>
              <p className="normal-text">
                Join a Study Support session on topics such as: English language
                development.
              </p>
            </div>
          </div>
      ...
      {/* skill sections card end here */}

      <div className="container mb-5 py-5 w-100">
        <div className="d-md-flex align-items-center justify-content-evenly">
          <div className="ms-5 w-75 mx-5">
          ...
          <div className="ms-5 w-25">
            ...
            <p className="normal-text my-5">
              ...
              who may be at risk of not meeting progression requirements for
